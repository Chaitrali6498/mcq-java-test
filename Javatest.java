...
class JavaTest extends JFrame implements ActionListener {
	...
	void set() {
		...
		if (current == 0) {
			label.setText("Que1:  What is used to find and fix bugs in the Java programs?");
		...
		if (current == 2) {
			label.setText("Que3: Which of the following is not a java feature?");
		...
		if (current == 7) {
			label.setText("Que8:  Which package contains the Random class?");
